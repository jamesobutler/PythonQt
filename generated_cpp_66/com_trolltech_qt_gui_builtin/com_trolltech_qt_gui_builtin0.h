...
void delete_QFont(QFont* obj) { delete obj; }
   ...
   QList<unsigned int >  featureTags(QFont* theWrappedObject) const;
   unsigned int  featureValue(QFont* theWrappedObject, unsigned int  tag) const;
   ...
   bool  isFeatureSet(QFont* theWrappedObject, unsigned int  tag) const;
   ...
   void setFeature(QFont* theWrappedObject, const char*  feature, unsigned int  value);
   void setFeature(QFont* theWrappedObject, unsigned int  tag, unsigned int  value);
   ...
   unsigned int  static_QFont_stringToTag(const char*  tagString);
   ...
   QByteArray  static_QFont_tagToString(unsigned int  tag);
   QString  toString(QFont* theWrappedObject) const;
   bool  underline(QFont* theWrappedObject) const;
   void unsetFeature(QFont* theWrappedObject, const char*  feature);
   void unsetFeature(QFont* theWrappedObject, unsigned int  tag);
