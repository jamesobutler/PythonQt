...
QList<unsigned int >  PythonQtWrapper_QFont::featureTags(QFont* theWrappedObject) const
{
  return ( theWrappedObject->featureTags());
}

unsigned int  PythonQtWrapper_QFont::featureValue(QFont* theWrappedObject, unsigned int  tag) const
{
...
bool  PythonQtWrapper_QFont::isFeatureSet(QFont* theWrappedObject, unsigned int  tag) const
{
...
void PythonQtWrapper_QFont::setFeature(QFont* theWrappedObject, const char*  feature, unsigned int  value)
{
  ( theWrappedObject->setFeature(feature, value));
}

void PythonQtWrapper_QFont::setFeature(QFont* theWrappedObject, unsigned int  tag, unsigned int  value)
{
...
unsigned int  PythonQtWrapper_QFont::static_QFont_stringToTag(const char*  tagString)
{
  return (QFont::stringToTag(tagString));
}
...
QByteArray  PythonQtWrapper_QFont::static_QFont_tagToString(unsigned int  tag)
{
  return (QFont::tagToString(tag));
}
...
void PythonQtWrapper_QFont::unsetFeature(QFont* theWrappedObject, const char*  feature)
{
  ( theWrappedObject->unsetFeature(feature));
}

void PythonQtWrapper_QFont::unsetFeature(QFont* theWrappedObject, unsigned int  tag)
{
